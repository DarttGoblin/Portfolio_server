    ...
    var mailOptions = {
        ...
        html: 
            `<div style="background-color: #f4f4f4; padding: 20px; border-radius: 10px; font-family: Arial, sans-serif; color: #333;">
                <h2 style="color: black;">New Contact Message</h2>
                <p style="font-size: 16px; margin-bottom: 20px;"><strong>Name:</strong><br> ${name}</p>
                <p style="font-size: 16px; margin-bottom: 20px;"><strong>Email:</strong><br> ${email}</p>
                <p style="font-size: 16px; margin-bottom: 20px;"><strong>Message:</strong><br> ${message}</p>
            </div>`
    };    
